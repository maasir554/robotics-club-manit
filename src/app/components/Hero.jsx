...
export const Hero = () => {
    ...
    return(
    <section id="hero-section" className="bg-[url('/herobg.png')] h-auto md:h-[200dvh] bg-top bg-portrait md:bg-landscape bg-no-repeat bg-fixed relative before:content-[''] before:h-full before:w-full before:bg-black before:flex before:-z-10 before:absolute before:top-0 ">
        ...
        {/* Big Heading */}
        <div className="w-full h-auto min-h-dvh flex items-center justify-center text-[18vw] md:text-[20vw] tracking-widest font-bold z-0">
            <h1  className="text-headingcolor text-center mb-8">
                ROBOTICS
            </h1>
        </div>
        {/* Button Box */}
        <div className="w-full h-hull min-h-[70dvh] md:h-dvh flex items-center justify-center p-10 ">
