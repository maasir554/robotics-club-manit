...
export const Hero = () => {
    ...
    return(
    <section id="hero-section" className="bg-[url('/herobg.png')] h-auto md:h-[200vh] bg-center bg-cover bg-no-repeat relative before:content-[''] before:h-full before:w-full before:bg-black before:flex before:-z-10 before:absolute before:top-0">
        
        {/* Our Mascot Robot */}
        <div id="robot-image" className=" w-full sm:w-3/4 md:w-1/2 h-auto flex items-center justify-center fixed left-1/2 -translate-x-1/2 top-[100vh] -translate-y-[100%]"
             style={{
        ...
        {/* Big Heading */}
        <div className="w-full h-screen flex items-center justify-center text-[18vw] md:text-[20vw] tracking-widest font-bold z-0">
            <h1  className="text-headingcolor text-center">
                ROBOTICS
            </h1>
        </div>
        {/* Button Box */}
        <div className="w-full h-[70vh] md:h-screen flex items-center justify-center p-5 ">
            <div className="relative w-[90vw] md:w-[80vw] lg:w-[70vw] bg-white/30 backdrop-blur-sm  h-[150px] sm:h-[35vw] md:h-[22vw] lg:h-[18vw] rounded-xl md:rounded-3xl overflow-visible flex flex-row justify-end items-end z-20">
